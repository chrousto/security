                    ...
                    public Tuple<String, Set<Tuple<String, Boolean>>> call() throws Exception {
                        ...
                        if (tenants != null) {
                            ...
                            for (RoleV7.Tenant tenant : tenants) {
                                ...
                                for(String matchingWildcardTenant: wildcardMatchingTenants) {

                                    tuples.add(new Tuple<String, Boolean>(matchingWildcardTenant, agr.resolvedActions(tenant.getAllowed_actions()).contains("kibana:saved_objects/*/write")));
                                }
